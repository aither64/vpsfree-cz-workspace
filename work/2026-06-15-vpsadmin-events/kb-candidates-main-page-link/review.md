...
| --- | --- | ---: | --- | --- |
| cs | domu | 1 |   * [[navody:vps:uzivatele\|Nastavení uživatelského účtu]] ↵   * [[navody:vps:rdns\|Reverzní záznamy]] |   * [[navody:vps:uzivatele\|Nastavení uživatelského účtu]] ↵   * [[navody:notifikace\|Notifikace]] ↵   * [[navody:vps:rdns\|Reverzní záznamy]] |
| en | home | 1 |   * [[manuals:vps:users\|User account settings]] ↵   * [[manuals:vps:rdns\|Reverse DNS]] |   * [[manuals:vps:users\|User account settings]] ↵   * [[manuals:notifications\|Notifications]] ↵   * [[manuals:vps:rdns\|Reverse DNS]] |
